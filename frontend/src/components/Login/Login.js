...
class LoginForm extends React.Component {
  ...
  render() {
    ...
    if (cookie.get("login")) {
      ...
      return (
        // No reason to use classes and raw css if you are using styled components
        // avoid it and stay consistent across whole app in technologies you use
        <div className="login">
